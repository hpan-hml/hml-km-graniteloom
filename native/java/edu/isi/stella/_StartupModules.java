  ...
  static void helpStartupModules1() {
    {
      ...
      Stella.SGT_STELLA_F_GET_STELLA_MODULE_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("F-GET-STELLA-MODULE-MEMO-TABLE-000", null, 1)));
      Stella.KWD_MODULE_UPDATE = ((Keyword)(Stella.internRigidSymbolWrtModule("MODULE-UPDATE", null, 2)));
      ...
      Stella.KWD_NAMESPACEp = ((Keyword)(Stella.internRigidSymbolWrtModule("NAMESPACE?", null, 2)));
      Stella.SYM_STELLA_NAMESPACEp = ((Symbol)(Stella.internRigidSymbolWrtModule("NAMESPACE?", null, 0)));
      ...
      Stella.KWD_TOPDOWN = ((Keyword)(Stella.internRigidSymbolWrtModule("TOPDOWN", null, 2)));
      ...
      Stella.SGT_STELLA_F_VISIBLE_MODULES_MEMO_TABLE_000 = ((Surrogate)(Stella.internRigidSymbolWrtModule("F-VISIBLE-MODULES-MEMO-TABLE-000", null, 1)));
    ...
    { Object old$Module$000 = Stella.$MODULE$.get();
      ...
      try {
        ...
        if (Stella.currentStartupTimePhaseP(4)) {
          ...
          Stella.$MODULE_NON_STRUCTURAL_OPTIONS$ = Stella_Object.cons(Stella.KWD_DOCUMENTATION, Stella.NIL);
        }
