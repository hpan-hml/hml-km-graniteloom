  ...
  static void helpStartupPropagate2() {
    {
      ...
      Stella.defineFunctionObject("PRINT-FACTS", "(DEFUN PRINT-FACTS ((INSTANCEREF OBJECT)) :DOCUMENTATION \"Like ALL-FACTS-OF, but prints each fact on a separate \nline on the standard output stream.\" :COMMAND? TRUE :PUBLIC? TRUE :EVALUATE-ARGUMENTS? FALSE)", Native.find_java_method("edu.isi.powerloom.logic.Logic", "printFacts", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object")}), null);
