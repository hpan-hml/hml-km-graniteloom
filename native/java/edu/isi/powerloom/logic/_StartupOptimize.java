  ...
  static void helpStartupOptimize2() {
    {
      ...
      Logic.V_0_0 = Logic.zeroOneListToBooleanVector(Stella.list(Stella_Object.cons(IntegerWrapper.wrapInteger(0), Stella_Object.cons(IntegerWrapper.wrapInteger(0), Stella.NIL))));
      Logic.V_1_0 = Logic.zeroOneListToBooleanVector(Stella.list(Stella_Object.cons(IntegerWrapper.wrapInteger(1), Stella_Object.cons(IntegerWrapper.wrapInteger(0), Stella.NIL))));
      Logic.V_0_1 = Logic.zeroOneListToBooleanVector(Stella.list(Stella_Object.cons(IntegerWrapper.wrapInteger(0), Stella_Object.cons(IntegerWrapper.wrapInteger(1), Stella.NIL))));
      Logic.V_1_1 = Logic.zeroOneListToBooleanVector(Stella.list(Stella_Object.cons(IntegerWrapper.wrapInteger(1), Stella_Object.cons(IntegerWrapper.wrapInteger(1), Stella.NIL))));
  ...
  static void helpStartupOptimize4() {
    {
      ...
      Stella.defineFunctionObject("MAP-AND-ENQUEUE-VARIABLE?", "(DEFUN (MAP-AND-ENQUEUE-VARIABLE? BOOLEAN) ((VARIABLE OBJECT) (LOCALVALUE OBJECT) (MAPPING ENTITY-MAPPING) (QUEUE LIST)))", Native.find_java_method("edu.isi.powerloom.logic.Logic", "mapAndEnqueueVariableP", new java.lang.Class [] {Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.Stella_Object"), Native.find_java_class("edu.isi.stella.KeyValueList"), Native.find_java_class("edu.isi.stella.List")}), null);
      ...
      Stella.defineFunctionObject("MAP-FUNCTIONAL-VALUE?", "(DEFUN (MAP-FUNCTIONAL-VALUE? BOOLEAN) ((PROPOSITION PROPOSITION) (MAPPING ENTITY-MAPPING) (QUEUE LIST)))", Native.find_java_method("edu.isi.powerloom.logic.Proposition", "mapFunctionalValueP", new java.lang.Class [] {Native.find_java_class("edu.isi.powerloom.logic.Proposition"), Native.find_java_class("edu.isi.stella.KeyValueList"), Native.find_java_class("edu.isi.stella.List")}), null);
