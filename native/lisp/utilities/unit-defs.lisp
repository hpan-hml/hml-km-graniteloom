...
"
  (CL:LET* ((M NULL)) (CL:SETQ M (DEFINE-BASE-MEASURE "Mass" "kg"))
   ...
   (ADD-UNIT M "acrefeet" 1.0d0 "acre.ft") (ADD-UNIT M "gallon" 231.0d0 "in3")
   (ADD-UNIT M "pint" 0.125d0 "gallon") (ADD-UNIT M "quart" 0.25d0 "gallon")
   (ADD-UNIT M "gal" 1.0d0 "gallon") (ADD-UNIT M "qt" 1.0d0 "quart")
   (ADD-UNIT M "floz" 0.0625d0 "pint") (ADD-UNIT M "barrel" 42.0d0 "gal")
   (ADD-UNIT M "cup" 0.5d0 "pint") (ADD-UNIT M "tbl" 0.0625d0 "cup")
   ...
   (ADD-UNIT M "Mibit" 1024.0d0 "kibit") (ADD-UNIT M "KiB" 1024.0d0 "byte")
   (ADD-UNIT M "kiB" 1.0d0 "KiB") (ADD-UNIT M "MiB" 1024.0d0 "KiB")
   (ADD-UNIT M "GiB" 1024.0d0 "MiB") (ADD-UNIT M "TiB" 1024.0d0 "GiB")
   (ADD-UNIT M "PiB" 1024.0d0 "TiB") (ADD-UNIT M "kbit" 1000.0d0 "bit")
   (ADD-UNIT M "Mbit" 1000.0d0 "kbit") (ADD-UNIT M "kB" 1000.0d0 "byte")
