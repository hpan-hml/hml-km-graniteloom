...
(CL:DECLAIM
  ...
  *STARTUP-TIME-PHASES* NIL-LIST NULL-STRING-WRAPPER *INLININGMETHODCALL?*
  ...
  NULL-INTEGER *CURRENTFILE* *IGNORETRANSLATIONERRORS?* STANDARD-WARNING
  TRUE-WRAPPER FALSE-WRAPPER *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE
  *MODULE* STANDARD-ERROR *TRANSLATOROUTPUTLANGUAGE* STANDARD-OUTPUT EOL NIL))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-004 NIL)) DO
     (CL:SETQ VAR (%%VALUE ITER-004)) (CL:SETQ VAR VAR) (POP-VARIABLE-BINDING)
     (CL:SETQ ITER-004 (%%REST ITER-004))))
     ...
     (CL:T (CL:SETF (%VARIABLE-CONSTANT? GLOBAL) CL:NIL)
      (WALK-AUXILIARY-TREE
       (LIST* SYM-WALK-STELLA-STARTUP-TIME-PROGN KWD-WALK-GLOBALS
        ...
        NIL))
      (CL:SETQ INITIALVALUETREE
       (TYPE-TO-WALKED-NULL-VALUE-TREE (%VARIABLE-TYPE GLOBAL)
