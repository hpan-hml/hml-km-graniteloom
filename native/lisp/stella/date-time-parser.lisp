...
(CL:DEFUN YESTERDAY (PARSED-VALUES DEFAULT-VALUES)
  ...
  (CL:WHEN
   (CL:AND (DEFINED? (%DATE-TIME-YEAR PARSED-VALUES))
    (DEFINED? (%DATE-TIME-MONTH PARSED-VALUES))
    (DEFINED? (%DATE-TIME-DAY PARSED-VALUES)))
   (CL:LET*
    ((JD
...
(CL:DEFUN TODAY (PARSED-VALUES DEFAULT-VALUES)
  ...
  (CL:WHEN (NULL? (%DATE-TIME-MONTH PARSED-VALUES))
   (CL:SETF (%DATE-TIME-MONTH PARSED-VALUES)
    (%DATE-TIME-MONTH DEFAULT-VALUES)))
  (CL:WHEN (NULL? (%DATE-TIME-YEAR PARSED-VALUES))
...
(CL:DEFUN HELP-STARTUP-DATE-TIME-PARSER2 ()
  (CL:PROGN
   ...
   (CL:LET*
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-044 NIL)) DO
     (CL:SETQ ITEM (%%VALUE ITER-044))
     (INSERT-AT *WEEKDAY-STRINGS* (%WRAPPER-VALUE (%%VALUE ITEM))
      (%%VALUE (%%REST ITEM)))
     (CL:SETQ ITER-044 (%%REST ITER-044))))
   (CL:LET*
    ((ITEM NULL)
     (ITER-045
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-045 NIL)) DO
     (CL:SETQ ITEM (%%VALUE ITER-045))
     (INSERT-AT *MONTH-STRINGS* (%WRAPPER-VALUE (%%VALUE ITEM))
      (%WRAPPER-VALUE (%%VALUE (%%REST ITEM))))
     (CL:SETQ ITER-045 (%%REST ITER-045))))
   (CL:LET*
    ((ITEM NULL)
     (ITER-046
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-046 NIL)) DO
     (CL:SETQ ITEM (%%VALUE ITER-046))
     (INSERT-AT *ZONE-STRINGS* (%WRAPPER-VALUE (%%VALUE ITEM))
      (%%VALUE (%%REST ITEM)))
     (CL:SETQ ITER-046 (%%REST ITER-046))))
   (CL:LET*
    ((ITEM NULL)
     (ITER-047
    ...
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-047 NIL)) DO
     (CL:SETQ ITEM (%%VALUE ITER-047))
     (INSERT-AT *ERA-STRINGS* (%WRAPPER-VALUE (%%VALUE ITEM))
      (%%VALUE (%%REST ITEM)))
     (CL:SETQ ITER-047 (%%REST ITER-047))))
   (CL:LET* ((SYMBOL NULL) (ITER-048 *SPECIAL-SYMBOLS*))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-048 NIL)) DO
     (CL:SETQ SYMBOL (%%VALUE ITER-048))
     (INSERT-AT *SPECIAL-STRINGS* (STRING-DOWNCASE (%SYMBOL-NAME SYMBOL))
      SYMBOL)
     (CL:SETQ ITER-048 (%%REST ITER-048))))
