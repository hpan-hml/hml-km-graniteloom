...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:DOUBLE-FLOAT) CL:SIMPLE-STRING)
  TIME-ZONE-FORMAT60))
(CL:DEFUN TIME-ZONE-FORMAT60 (TIMEZONE)
  ...
  (CL:LET* ((SIGN "+") (HOURS 0))
   ...
   (CL:RETURN-FROM TIME-ZONE-FORMAT60
    (CONCATENATE SIGN
     (FORMAT-WITH-PADDING (INTEGER-TO-STRING HOURS) 2 #\0 KWD-DATE-TIME-RIGHT
      CL:NIL)
     ":"
     (FORMAT-WITH-PADDING
      (INTEGER-TO-STRING (ROUND (CL:* (CL:- TIMEZONE HOURS) 60.0d0))) 2 #\0
...
be included (if present) if a time value is given."
  (CL:LET* ((BUFFER (MAKE-RAW-MUTABLE-STRING 25)) (INDEX 0))
   ...
   (CL:WHEN (DEFINED? (%DATE-TIME-YEAR DATE))
    (CL:SETQ INDEX
     (INSERT-STRING (INTEGER-TO-STRING (%DATE-TIME-YEAR DATE)) 0 NULL-INTEGER
      BUFFER INDEX KWD-DATE-TIME-PRESERVE))
    (CL:WHEN (DEFINED? (%DATE-TIME-MONTH DATE))
     (CL:SETQ INDEX
      (INSERT-STRING "-" 0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
     (CL:SETQ INDEX
      (INSERT-STRING
       (FORMAT-WITH-PADDING (INTEGER-TO-STRING (%DATE-TIME-MONTH DATE)) 2 #\0
        KWD-DATE-TIME-RIGHT CL:NIL)
       0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
     (CL:WHEN (DEFINED? (%DATE-TIME-DAY DATE))
      (CL:SETQ INDEX
       (INSERT-STRING "-" 0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
      (CL:SETQ INDEX
       (INSERT-STRING
        (FORMAT-WITH-PADDING (INTEGER-TO-STRING (%DATE-TIME-DAY DATE)) 2 #\0
         KWD-DATE-TIME-RIGHT CL:NIL)
        0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
      (CL:WHEN (DEFINED? (%DATE-TIME-HOUR DATE))
       (CL:SETQ INDEX
        (INSERT-STRING "T" 0 NULL-INTEGER BUFFER INDEX
         KWD-DATE-TIME-PRESERVE))
       (CL:SETQ INDEX
        (INSERT-STRING
         (FORMAT-WITH-PADDING (INTEGER-TO-STRING (%DATE-TIME-HOUR DATE)) 2 #\0
          KWD-DATE-TIME-RIGHT CL:NIL)
         0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
       (CL:WHEN (DEFINED? (%DATE-TIME-MINUTE DATE))
        (CL:SETQ INDEX
         (INSERT-STRING ":" 0 NULL-INTEGER BUFFER INDEX
          KWD-DATE-TIME-PRESERVE))
        (CL:SETQ INDEX
         (INSERT-STRING
          (FORMAT-WITH-PADDING (INTEGER-TO-STRING (%DATE-TIME-MINUTE DATE)) 2
           #\0 KWD-DATE-TIME-RIGHT CL:NIL)
          0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))
        (CL:WHEN (DEFINED? (%DATE-TIME-SECOND DATE))
         (CL:SETQ INDEX
          (INSERT-STRING ":" 0 NULL-INTEGER BUFFER INDEX
           KWD-DATE-TIME-PRESERVE))
         (CL:SETQ INDEX
          (INSERT-STRING
           (FORMAT-WITH-PADDING (INTEGER-TO-STRING (%DATE-TIME-SECOND DATE)) 2
            #\0 KWD-DATE-TIME-RIGHT CL:NIL)
           0 NULL-INTEGER BUFFER INDEX KWD-DATE-TIME-PRESERVE))))
        ...
        (CL:IF (CL:= (%DATE-TIME-ZONE DATE) 0.0d0)
         (CL:SETQ INDEX
          (INSERT-STRING "Z" 0 NULL-INTEGER BUFFER INDEX
           KWD-DATE-TIME-PRESERVE))
         (CL:SETQ INDEX
          (INSERT-STRING (TIME-ZONE-FORMAT60 (%DATE-TIME-ZONE DATE)) 0
...
(CL:DEFMETHOD SET-CONSISTENT-DOW ((SELF DECODED-DATE-TIME))
  (CL:WHEN
   (CL:AND (DEFINED? (%DATE-TIME-YEAR SELF))
    (DEFINED? (%DATE-TIME-MONTH SELF)) (DEFINED? (%DATE-TIME-DAY SELF)))
...
(CL:DEFMETHOD HELP-MERGE-NULL-FIELDS ((SELF DECODED-DATE-TIME) DEFAULT INDEX)
  ...
  (CL:WHEN (CL:AND (NULL? (%DATE-TIME-YEAR SELF)) (CL:>= INDEX 0))
   (CL:SETF (%DATE-TIME-YEAR SELF) (%DATE-TIME-YEAR DEFAULT)))
  (CL:WHEN (CL:AND (NULL? (%DATE-TIME-MONTH SELF)) (CL:>= INDEX 1))
   (CL:SETF (%DATE-TIME-MONTH SELF) (%DATE-TIME-MONTH DEFAULT)))
  (CL:WHEN (CL:AND (NULL? (%DATE-TIME-DAY SELF)) (CL:>= INDEX 2))
   (CL:SETF (%DATE-TIME-DAY SELF) (%DATE-TIME-DAY DEFAULT)))
  (CL:WHEN (CL:AND (NULL? (%DATE-TIME-HOUR SELF)) (CL:>= INDEX 3))
   (CL:SETF (%DATE-TIME-HOUR SELF) (%DATE-TIME-HOUR DEFAULT)))
  (CL:WHEN (CL:AND (NULL? (%DATE-TIME-MINUTE SELF)) (CL:>= INDEX 4))
   (CL:SETF (%DATE-TIME-MINUTE SELF) (%DATE-TIME-MINUTE DEFAULT)))
  (CL:WHEN (CL:AND (NULL? (%DATE-TIME-SECOND SELF)) (CL:>= INDEX 5))
...
of the answer."
  (CL:COND
   ...
   ((DEFINED? (%DATE-TIME-HOUR SELF)) (HELP-MERGE-NULL-FIELDS SELF DEFAULT 3))
   ((DEFINED? (%DATE-TIME-DAY SELF)) (HELP-MERGE-NULL-FIELDS SELF DEFAULT 2))
  ...
  (CL:LET*
   ...
   (CL:LET*
    ((YEAR-STRING
     ...
     (MONTH-STRING
      (CL:IF NUMERIC-MONTH?
       (FORMAT-WITH-PADDING (INTEGER-TO-STRING MONTH) 2 #\0
        KWD-DATE-TIME-RIGHT CL:NIL)
       (UNWRAP-STRING
        (CL:AREF
  ...
  (CL:LET*
   ...
   (CL:LET*
    ...
    (CL:RETURN-FROM CALENDAR-DATE-TO-TIME-STRING
     (CONCATENATE
      (CL:IF PAD-HOURS?
       (FORMAT-WITH-PADDING (INTEGER-TO-STRING HOURS) 2 #\0
        KWD-DATE-TIME-RIGHT CL:NIL)
  ...
  (CL:LET* ((TZ-STRING "")) (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING TZ-STRING))
   (CL:WHEN INCLUDE-TIMEZONE?
    (CL:IF (CL:= TIMEZONE 0.0d0) (CL:SETQ TZ-STRING "Z")
     (CL:SETQ TZ-STRING (TIME-ZONE-FORMAT60 TIMEZONE))))
    ...
    (CL:IF (CL:<= N-MILLIS 0)
     ...
     (CL:RETURN-FROM TIME-DURATION-TO-STRING
      (CONCATENATE "minus " (INTEGER-TO-STRING (CL:- 0 (CL:1+ N-DAYS)))
       " days; " (INTEGER-TO-STRING (CL:- MILLIS-PER-DAY N-MILLIS)) " ms")))
    (CL:IF (CL:< N-MILLIS 0)
     (CL:IF (CL:> N-DAYS 0)
      (CL:RETURN-FROM TIME-DURATION-TO-STRING
...
returns 0.0\")" (CL:FUNCTION GET-LOCAL-TIME-ZONE-FOR-DATE) NULL)
   (DEFINE-FUNCTION-OBJECT "TIME-ZONE-FORMAT60"
    "(DEFUN (TIME-ZONE-FORMAT60 STRING) ((TIMEZONE FLOAT)) :PUBLIC? FALSE :DOCUMENTATION \"Format `zone' as an hh:mm string\")"
...
(CL:DEFUN STARTUP-DATE-TIME ()
  (CL:LET* ((*MODULE* *STELLA-MODULE*) (*CONTEXT* *MODULE*))
   ...
   (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 4)
    ...
    (CL:LET*
     ((I NULL-INTEGER) (ITER-034 0) (UPPER-BOUND-035 12) (ABBREVIATION NULL)
      (ITER-036
       (GET-QUOTED-TREE
        "((\"NUL\" \"JAN\" \"FEB\" \"MAR\" \"APR\" \"MAY\" \"JUN\" \"JUL\" \"AUG\" \"SEP\" \"OCT\" \"NOV\" \"DEC\") \"/STELLA\")"
        "/STELLA")))
     (CL:DECLARE (CL:TYPE CL:FIXNUM I ITER-034 UPPER-BOUND-035))
     (CL:LOOP WHILE
      (CL:AND (CL:<= ITER-034 UPPER-BOUND-035) (CL:NOT (CL:EQ ITER-036 NIL)))
      DO (CL:SETQ I ITER-034) (CL:SETQ ABBREVIATION (%%VALUE ITER-036))
      (CL:LET
      ...
      (CL:SETQ ITER-034 (CL:1+ ITER-034))
      (CL:SETQ ITER-036 (%%REST ITER-036))))
    (CL:SETQ *DEFAULT-DECODED-DATE-TIME* (NEW-DECODED-DATE-TIME))
    (CL:LET* ((SELF-038 (NEW-DECODED-DATE-TIME)))
     (CL:SETF (%DATE-TIME-MILLIS SELF-038) NULL-FLOAT)
     (CL:SETF (%DATE-TIME-SECOND SELF-038) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-MINUTE SELF-038) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-HOUR SELF-038) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-DAY SELF-038) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-MONTH SELF-038) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-YEAR SELF-038) NULL-INTEGER)
     (CL:SETF (%DATE-TIME-ZONE SELF-038) NULL-FLOAT)
     (CL:SETF (%DATE-TIME-DOW SELF-038) NULL)
     (CL:SETQ *NULL-DECODED-DATE-TIME* SELF-038)))
