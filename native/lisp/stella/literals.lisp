...
(CL:DEFVAR SYM-LITERALS-STELLA-NULL-STRING NULL)
...
(CL:DECLAIM
  ...
  *CLASS-HIERARCHY-BOOTED?* NIL EOL NULL-CHARACTER NULL-FLOAT NULL-INTEGER))
...
(CL:DEFUN PRINT-STRING-READABLY (STRING STREAM)
  ...
  (CL:IF (CL:EQ STRING STELLA::NULL-STRING)
   (%%PRINT-STREAM STREAM SYM-LITERALS-STELLA-NULL-STRING)
   (CL:PROGN (%%PRINT-STREAM STREAM "\"")
    (CL:LET*
...
(CL:DEFUN HELP-STARTUP-LITERALS1 ()
  (CL:PROGN
   ...
   (CL:SETQ SYM-LITERALS-STELLA-NULL-STRING
