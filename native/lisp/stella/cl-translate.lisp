...
(CL:DECLAIM
 (CL:SPECIAL *STELLA-MODULE* NULL-INTEGER FALSE-WRAPPER NIL-LIST ONE-WRAPPER
...
(CL:DEFUN CL-TRANSLATE-DEFINE-METHOD-UNIT (UNIT)
  (CL:LET*
   ...
   (CL:IF (CL:AND (CL:NOT FUNCTION?) (%ABSTRACT? METHOD))
    (CL:SETQ OTREE
     (LIST* (INTERN-COMMON-LISP-SYMBOL "DEFGENERIC")
      (CL-TRANSLATE-GLOBAL-SYMBOL
...
(CL:DEFUN CL-TRANSLATE-DEFINE-GLOBAL-VARIABLE-UNIT (UNIT)
  (CL:LET*
   ...
   (CL:DECLARE (CL:TYPE CL:SIMPLE-STRING DOCUMENTATION))
   (CL:WHEN (CL:AND (%VARIABLE-CONSTANT? GLOBAL) CL:NIL)
