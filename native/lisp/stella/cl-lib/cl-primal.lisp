...
(CL:DECLAIM
 (CL:SPECIAL NIL KEYWORD-SYM *ROOT-MODULE* *STELLA-MODULE* SYMBOL-SYM
  NULL-INTEGER SURROGATE-SYM *MODULE*))
...
entire string."
  ...
  (CL:IF (NULL? END) (CL:SETQ END (CL:THE CL:FIXNUM (CL:LENGTH STRING)))
...
Helping function for `integer-to-string' and `integer-to-hex-string'"
  (CL:DECLARE (CL:TYPE CL:FIXNUM INTEGER BASE))
  #+MCL
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:FIXNUM) CL:SIMPLE-STRING) INTEGER-TO-HEX-STRING))
...
integer and return the result."
  ...
  #+MCL
  (CL:CHECK-TYPE STRING CL:SIMPLE-STRING)
  (CL:RETURN-FROM STRING-TO-INTEGER (CL:LET ((i (CL:parse-integer string)))
...
'end' value of NULL stands for the rest of the string.\")"
    ...
    (DEFINE-FUNCTION-OBJECT "INTEGER-TO-STRING-IN-BASE"
     "(DEFUN (INTEGER-TO-STRING-IN-BASE STRING) ((INTEGER INTEGER) (BASE INTEGER)) :PUBLIC? TRUE :DOCUMENTATION \"Return a string representation of `integer' in `base'.
Helping function for `integer-to-string' and `integer-to-hex-string'\")"
    ...
    (DEFINE-FUNCTION-OBJECT "INTEGER-TO-HEX-STRING"
     "(DEFUN (INTEGER-TO-HEX-STRING STRING) ((INTEGER INTEGER)) :DOCUMENTATION \"Return a hex string representation of 'integer'.\" :PUBLIC? TRUE)"
...
float and return the result.\" :PUBLIC? TRUE)" (CL:FUNCTION STRING-TO-FLOAT)
    ...
    (DEFINE-FUNCTION-OBJECT "DELETE-FILE"
     "(DEFUN DELETE-FILE ((FILENAME FILE-NAME)))" (CL:FUNCTION DELETE-FILE)
     NULL)
