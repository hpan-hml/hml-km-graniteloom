...
(CL:DECLAIM
  ...
  *CLASSIFY-FROM-NON-INFERABLE-PARENTS-ONLY?* *QUERY-OPTIMIZATION-STRATEGY*
  STANDARD-ERROR *MOST-RECENT-QUERY* *PRINTLENGTH* *PRINTREADABLY?*
  *CYC-KLUDGES-ENABLED?* *MEMOIZATION-ENABLED?* MEMOIZED-NULL-VALUE
  ZERO-WRAPPER *RECORD-JUSTIFICATIONS?* *CACHE-SUCCEEDED-GOALS?*
  *CACHE-FAILED-GOALS?* *CONTEXT* NULL-INTEGER-WRAPPER
  *PARTIAL-SUPPORT-COUNTER* NULL-FLOAT-WRAPPER *FAIL-UNBOUND-CLAUSES?*
  TRUE-TRUTH-VALUE FALSE-TRUTH-VALUE UNKNOWN-TRUTH-VALUE STANDARD-WARNING
  ONE-WRAPPER STANDARD-OUTPUT DEFAULT-TRUE-TRUTH-VALUE
  DEFAULT-FALSE-TRUTH-VALUE NIL TRUE-WRAPPER FALSE-WRAPPER NIL-LIST NULL-FLOAT
  *TRACED-KEYWORDS* *CURRENT-POWERLOOM-FEATURES* NULL-INTEGER EOL
...
(CL:DEFUN HELP-STARTUP-QUERY6 ()
  (CL:PROGN
   ...
   (CL:LET* ((SELF-036 (NEW-BOOLEAN-VECTOR-INDEX-NODE)))
    (CL:SETF (%THE-VECTOR SELF-036) (NEW-BOOLEAN-VECTOR 0))
