         ...
         (CL:LET* ((TYPE2 NULL) (ITER-001 SECONDARGTYPES))
          (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-001 NIL)) DO
           ...
           (CL:WHEN (DISJOINT-TERMS? TYPE1 TYPE2) (CL:SETQ FOUND?-000 CL:T)
            (CL:RETURN))
           (CL:SETQ ITER-001 (%%REST ITER-001))))
         (CL:WHEN FOUND?-000 (SIGNAL-UNIFICATION-CLASH FIRSTARG SECONDARG)))
        (CL:SETQ ITER-000 (%%REST ITER-000)))))
...
(CL:DEFUN EVALUATE-FUNCTION-PROPOSITION (SELF)
  ...
  (CL:LET*
   ((DESCRIPTION (GET-DESCRIPTION (%OPERATOR SELF)))
    (CODE (LOOKUP-CONSTRAINT DESCRIPTION)) (STOREDVALUE NULL)
   ...
   (CL:WHEN (CL:NOT (CL:EQ CODE NULL))
    (CL:MULTIPLE-VALUE-SETQ (COMPUTEDVALUE MISSINGVALUEINDEX)
     (COMPUTE-SIMPLE-RELATION-CONSTRAINT SELF CODE CL:NIL))
   ...
   (CL:WHEN (CL:NOT (CL:EQ CODE NULL))
    (CL:SETQ COMPUTEDVALUE (COMPUTE-RELATION-VALUE SELF CODE CL:NIL))
    (CL:WHEN (CL:NOT (CL:EQ COMPUTEDVALUE NULL))
...
line on the standard output stream."
  (CL:LET* ((INSTANCE (COERCE-TO-INSTANCE INSTANCEREF NULL)))
   (CL:LET*
    ((FACT NULL)
     (ITER-000
      (%THE-CONS-LIST (ALL-FACTS-OF-INSTANCE INSTANCE CL:NIL CL:NIL))))
    (CL:LOOP WHILE (CL:NOT (CL:EQ ITER-000 NIL)) DO
...
`fred' as well as a function term such as `(father fred)'.\")"
   ...
   (DEFINE-FUNCTION-OBJECT "PRINT-FACTS"
    "(DEFUN PRINT-FACTS ((INSTANCEREF OBJECT)) :DOCUMENTATION \"Like ALL-FACTS-OF, but prints each fact on a separate 
line on the standard output stream.\" :COMMAND? TRUE :PUBLIC? TRUE :EVALUATE-ARGUMENTS? FALSE)"
