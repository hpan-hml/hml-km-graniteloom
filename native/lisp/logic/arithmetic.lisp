...
(CL:DECLAIM
 (CL:SPECIAL *STARTUP-TIME-PHASE* *MODULE* STANDARD-OUTPUT NIL
  *REVERSEPOLARITY?* UNKNOWN-TRUTH-VALUE TRUE-TRUTH-VALUE FALSE-TRUTH-VALUE
  EOL *CONTEXT* TRUE-WRAPPER FALSE-WRAPPER NULL-INTEGER NULL-FLOAT))
...
(CL:DEFUN |/PL-KERNEL-KB/NEW-INTERVAL-CACHE| ()
  (CL:LET* ((SELF NULL))
   ...
   (CL:SETF (%DYNAMIC-SLOTS SELF) (NEW-KEY-VALUE-LIST))
   (CL:SETF (%SURROGATE-VALUE-INVERSE SELF) NULL)
   (CL:SETF (|/PL-KERNEL-KB/%STRICT-UPPER-BOUND?| SELF) CL:NIL)
   (CL:SETF (|/PL-KERNEL-KB/%STRICT-LOWER-BOUND?| SELF) CL:NIL)
...
(CL:DEFMETHOD PRINT-OBJECT ((SELF |/PL-KERNEL-KB/INTERVAL-CACHE|) STREAM)
  (CL:PROGN
   ...
   (|/PL-KERNEL-KB/PRINT-INTERVAL| STREAM (%LOWER-BOUND SELF)
    (|/PL-KERNEL-KB/%STRICT-LOWER-BOUND?| SELF) (%UPPER-BOUND SELF)
    (|/PL-KERNEL-KB/%STRICT-UPPER-BOUND?| SELF))
   (%%PRINT-STREAM STREAM "|")))
    ...
    ((CL:AND (CL:NOT (CL:EQ INTERVALCACHE NULL))
     ...
     (CL:LET* ((THISCACHE INTERVALCACHE) (COPYCACHE NULL) (PROPOSITION NULL))
      ...
      (CL:LET* ((SELF-000 (|/PL-KERNEL-KB/NEW-INTERVAL-CACHE|)))
       ...
       (CL:SETF (|/PL-KERNEL-KB/%INTERVAL-MEMBER| SELF-000) SELF)
       (CL:SETF (%LOWER-BOUND SELF-000) (%LOWER-BOUND THISCACHE))
       (CL:SETF (%UPPER-BOUND SELF-000) (%UPPER-BOUND THISCACHE))
       (CL:SETF (|/PL-KERNEL-KB/%STRICT-LOWER-BOUND?| SELF-000)
        (|/PL-KERNEL-KB/%STRICT-LOWER-BOUND?| THISCACHE))
       (CL:SETF (|/PL-KERNEL-KB/%STRICT-UPPER-BOUND?| SELF-000)
        (|/PL-KERNEL-KB/%STRICT-UPPER-BOUND?| THISCACHE))
...
(CL:DEFMETHOD |/PL-KERNEL-KB/INTEGER-VALUED-MEMBER?| ((INTERVAL |/PL-KERNEL-KB/INTERVAL-CACHE|))
  (CL:LET* ((MEMBER (|/PL-KERNEL-KB/%INTERVAL-MEMBER| INTERVAL)))
   ...
   (CL:WHEN (CL:NOT (CL:EQ LB NULL))
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE LB)))
     (CL:COND
      ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
       (CL:PROGN
        (CL:IF (|/PL-KERNEL-KB/%STRICT-LOWER-BOUND?| INTERVAL)
   ...
   (CL:WHEN (CL:NOT (CL:EQ UB NULL))
    (CL:LET* ((TEST-VALUE-000 (SAFE-PRIMARY-TYPE UB)))
     (CL:COND
      ((SUBTYPE-OF-INTEGER? TEST-VALUE-000)
       (CL:PROGN
        (CL:IF (|/PL-KERNEL-KB/%STRICT-UPPER-BOUND?| INTERVAL)
...
(CL:DEFMETHOD |/PL-KERNEL-KB/EVALUATE-TIGHTER-INTEGER-INTERVAL| ((INTERVAL |/PL-KERNEL-KB/INTERVAL-CACHE|))
  (CL:LET*
   ...
   (CL:WHEN
    ...
    (EQUATE-VALUES (|/PL-KERNEL-KB/%INTERVAL-MEMBER| INTERVAL) LB))))
    ...
    (CL:COND
     ((CL:EQ OPERATOR |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB->|)
      (CL:WHEN
       ...
       (CL:SETF (|/PL-KERNEL-KB/%STRICT-LOWER-BOUND?| SELF) CL:T)
     ...
     ((CL:EQ OPERATOR |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-<|)
      (CL:WHEN
       ...
       (CL:SETF (|/PL-KERNEL-KB/%STRICT-UPPER-BOUND?| SELF) CL:T)
       (CL:SETQ TIGHTERINTERVAL? CL:T)))
     ((CL:EQ OPERATOR |/PL-KERNEL-KB/SGT-ARITHMETIC-PL-KERNEL-KB-=<|)
      (CL:WHEN
       (CL:OR (CL:EQ (%UPPER-BOUND SELF) NULL)
       ...
       (CL:LET*
        ...
        (CL:COND
         ...
         ((STRING-EQL?
          ...
          (CL:RETURN-FROM |/PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST|
           (SELECT-PROOF-RESULT
            (BIND-ARGUMENT-TO-VALUE? P1ARG (WRAP-INTEGER (CL:- P2 LSUB)) CL:T)
            CL:NIL CL:T)))
         (CL:T
          (CL:RETURN-FROM |/PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST|
           |/PL-KERNEL-KB/KWD-ARITHMETIC-TERMINAL-FAILURE|))))))
      ...
      (CL:LET*
       ...
       (CL:COND
        ...
        ((STRING-EQL? SUB (SUBSEQUENCE SUPER P1 (CL:+ P1 LSUB)))
         (CL:RETURN-FROM |/PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST|
          (SELECT-PROOF-RESULT
           (BIND-ARGUMENT-TO-VALUE? P2ARG (WRAP-INTEGER (CL:+ P1 LSUB)) CL:T)
           CL:NIL CL:T)))
        (CL:T
         (CL:RETURN-FROM |/PL-KERNEL-KB/SUBSEQUENCE-SPECIALIST|
          |/PL-KERNEL-KB/KWD-ARITHMETIC-TERMINAL-FAILURE|)))))
     (CL:T
      (CL:LET*
       ((SUPER-STRING (UNWRAP-STRING SUPERARGVALUE))
        ...
        (MATCH?
         (CL:AND (CL:<= END-INDEX (CL:THE CL:FIXNUM (CL:LENGTH SUPER-STRING)))
          (BIND-ARGUMENT-TO-VALUE? SUBARG
           (WRAP-STRING (SUBSEQUENCE SUPER-STRING BEGIN-INDEX END-INDEX))
           CL:T))))
