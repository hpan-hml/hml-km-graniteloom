...
Ontolingua conventions.\" :USES (\"LOGIC\" \"STELLA\"))")
   ...
   (CL:LET*
    ...
    (CL:WHEN (CURRENT-STARTUP-TIME-PHASE? 9)
     ...
     (CL:LET* ((PHASE NULL-INTEGER) (ITER-062 0) (UPPER-BOUND-063 9))
      (CL:DECLARE (CL:TYPE CL:FIXNUM PHASE ITER-062 UPPER-BOUND-063))
      (CL:LOOP WHILE (CL:<= ITER-062 UPPER-BOUND-063) DO
       (CL:SETQ PHASE ITER-062) (CL:SETQ *STARTUP-TIME-PHASE* PHASE)
       ...
       (STARTUP-TOOLS) (CL:SETQ ITER-062 (CL:1+ ITER-062))))
