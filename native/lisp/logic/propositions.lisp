...
(CL:DECLAIM
  ...
  *DESCRIPTIONUNDERCONSTRUCTION* *LOGICVARIABLETABLE* *INTEGER-MSB-MASK*
  STANDARD-ERROR *TERMUNDERCONSTRUCTION* *DONTUSEDEFAULTKNOWLEDGE?*
  *QUERYITERATOR* *SUPPRESSNONLOGICOBJECTWARNING?* TRUE-TRUTH-VALUE
  FALSE-TRUTH-VALUE TRUE-PROPOSITION FALSE-PROPOSITION
  INCONSISTENT-TRUTH-VALUE DEFAULT-TRUE-TRUTH-VALUE DEFAULT-FALSE-TRUTH-VALUE
   ...
   (CL:COND
    ((SUBTYPE-OF? TEST-VALUE-000 SGT-PROPOSITIONS-LOGIC-PATTERN-VARIABLE)
     (CL:PROGN
      (CL:WHEN
       (CL:NOT
        (CL:EQ (LOOKUP-LOGIC-VARIABLE-BINDING (%SKOLEM-NAME SELF)) NULL))
...
(CL:DECLAIM
 (CL:FTYPE (CL:FUNCTION (CL:T CL:T) CL:FIXNUM) PROPOSITION-HASH-INDEX))
(CL:DEFUN PROPOSITION-HASH-INDEX (SELF MAPPING)
  (CL:LET*
    ...
    (CL:LOOP WHILE (CL:< INDEX-000 LENGTH-000) DO
     ...
     (CL:IF (CL:EQ ARG NULL)
      ...
      (CL:LET* ((TEST-VALUE-001 (SAFE-PRIMARY-TYPE ARG)))
       (CL:COND
        ((SUBTYPE-OF? TEST-VALUE-001 SGT-PROPOSITIONS-LOGIC-PROPOSITION)
         (CL:PROGN (CL:SETQ ARGCODE (PROPOSITION-HASH-INDEX ARG MAPPING))))
         ...
         (CL:PROGN
          (CL:LET* ((DEFININGPROP (%DEFINING-PROPOSITION ARG)))
           (CL:IF
            ...
            (CL:SETQ ARGCODE (PROPOSITION-HASH-INDEX DEFININGPROP MAPPING))
            (CL:SETQ ARGCODE
             (CL:LET ((SELF SGT-PROPOSITIONS-LOGIC-SKOLEM))
              (CL:THE CL:FIXNUM (STELLA::%%OBJECT-HASH-CODE SELF))))))))
...
(CL:DEFUN FIND-DUPLICATE-COMPLEX-PROPOSITION (SELF)
  (CL:LET*
   ((INDEX (WRAP-INTEGER (PROPOSITION-HASH-INDEX SELF NULL)))
        ...
        (CL:PROGN
         (CL:WHEN
          ...
          (CL:LOOP
           (CL:TAGBODY
            (CL:LET* ((TEST-VALUE-000 CL:NIL))
             (CL:SETQ TEST-VALUE-000 FUNCTION?)
             (CL:WHEN TEST-VALUE-000
              (CL:LET* ((ALWAYS?-000 CL:T))
               (CL:LET*
             ...
             (CL:WHEN (CL:NOT TEST-VALUE-000)
              (CL:SETQ TEST-VALUE-000
               (CL:AND (CL:NOT FUNCTION?)
                (EQUIVALENT-PROPOSITIONS? SELF P NULL))))
             (CL:WHEN TEST-VALUE-000
  ...
  (CL:LET*
   ((SETPROP
     (BEGIN-CREATING-FUNCTION-PROPOSITION SGT-PROPOSITIONS-PL-KERNEL-KB-SETOF
      (SORT (COPY-CONS-LIST (%THE-CONS-LIST SET))
...
with size less than `sizeCutoff' (default is 10).\" :PUBLIC? TRUE)"
   ...
   (DEFINE-FUNCTION-OBJECT "PROPOSITION-HASH-INDEX"
    "(DEFUN (PROPOSITION-HASH-INDEX INTEGER) ((SELF PROPOSITION) (MAPPING ENTITY-MAPPING)))"
